<template>
  <div>
    <Toolbar class="min-w-100 mb-3">
      <template #start>
        <Button
          ...
          severity="primary"
          size="small"
          @click="handleShowSampleForm('new')"
        />
      </template>
      <template #end>
        <IconField>
      ...
      <Column header="Action">
        <template #body="{ data }">
          <Button
            ...
            rounded
            variant="outlined"
            @click="handleDeleteSample(data.id)"
          ></Button>
        </template>
      </Column>
      <template #expansion="{ data }">
        ...
        >
            ...
            <Column header="Action">
              <template #body="props">
                <Button
                  ...
                  rounded
                  variant="outlined"
                  @click="handleDeleteSampleTask(data.id, props.data.id)"
                ></Button>
              </template>
            </Column>
          ...
          <Button
            ...
            label="Add"
            variant="outlined"
            @click="handleAddSampleTask(data.id)"
          ></Button>
        </div>
      </template>
    ...
    <AddSampleTask
      v-if="showAddSampleTask"
      v-bind="addSampleTaskProps"
      @close="showAddSampleTask = false"
