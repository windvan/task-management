...
def create_test_data(engin):
    ...
    task_library_data = [
        ...
        TaskLibrary(task_category="Unplanned",
                    task_name="DRA SCOPING", default_task_owner_id=None, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name="ERA SCOPING", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name="RESIDUE SCOPING", default_task_owner_id=None, created_by=1),
        TaskLibrary(task_category="Unplanned",
