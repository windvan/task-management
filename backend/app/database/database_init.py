...
def create_test_data(engin):
    ...
    task_library_data = [
        TaskLibrary(task_category="Tox_Study",
                    task_name_prefix="Acute Oral", default_task_owner_id=3, created_by=1),
        TaskLibrary(task_category="Tox_Study",
                    task_name_prefix="Acute Dermal", default_task_owner_id=3, created_by=1),
        TaskLibrary(task_category="Tox_Study",
                    task_name_prefix="Eye Irritation", default_task_owner_id=3, created_by=1),
        TaskLibrary(task_category="Tox_Study",
                    task_name_prefix="Skin Irritation", default_task_owner_id=3, created_by=1),
        TaskLibrary(task_category="Tox_Study",
                    task_name_prefix="Skin Sensitization", default_task_owner_id=3, created_by=1),
        TaskLibrary(task_category="Tox_Study",
                    task_name_prefix="Acute inhalation", default_task_owner_id=3, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Avian Acute oral toxicity", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Acute toxcity to daphnia", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Algal Growth Inhibition", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Acute toxicity to trichogrammatid", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Acute toxicity to silkworm", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Acute toxicity to ladybird", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Acute oral toxicity to bee", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Acute contact toxicity to bee", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Acute toxicity to earthworm", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Eco_Tox_Study",
                    task_name_prefix="Acute fish toxicity", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Risk_Assessment",
                    task_name_prefix="Operator risk assessment", default_task_owner_id=3, created_by=1),
        TaskLibrary(task_category="Risk_Assessment",
                    task_name_prefix="Environment risk assessment", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Risk_Assessment",
                    task_name_prefix="Dietary risk assessment", default_task_owner_id=None, created_by=1),
        TaskLibrary(task_category="Residue_Study",
                    task_name_prefix="Residue study", default_task_owner_id=None, created_by=1),
        TaskLibrary(task_category="Processing_Residue_Study",
                    task_name_prefix="Processing_residue_study", default_task_owner_id=None, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="OPEX_SCOPING", default_task_owner_id=3, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="DRA SCOPING", default_task_owner_id=None, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="ERA SCOPING", default_task_owner_id=2, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="RESIDUE SCOPING", default_task_owner_id=None, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="Deco_Doc", default_task_owner_id=7, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="Statement", default_task_owner_id=None, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="Label_Review", default_task_owner_id=7, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="Check_List", default_task_owner_id=7, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="Risk_Matrix", default_task_owner_id=7, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="Gov_Doc_Tox", default_task_owner_id=3, created_by=1),
        TaskLibrary(task_category="Unplanned",
                    task_name_prefix="Gov_Doc_EcoTox", default_task_owner_id=2, created_by=1),
    ]
